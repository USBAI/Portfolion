          ...
          <div className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 p-8 rounded-xl backdrop-blur-sm border border-white/10">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 text-gray-300">
                ...
                <span className="text-lg">Stockholm, Sweden</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 p-8 rounded-xl backdrop-blur-sm border border-white/10">
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <span className="text-lg text-gray-300 group-hover:text-white transition-colors">Follow on GitHub</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-lg text-gray-300 group-hover:text-white transition-colors">Connect on LinkedIn</span>
              </a>
            </div>
          </div>
        </motion.div>
